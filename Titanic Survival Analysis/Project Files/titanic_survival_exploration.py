...
# ## Getting Started
# In this project we will see how decision trees work by implementing a decision tree in sklearn.
# 
...
model=DecisionTreeClassifier(max_depth=12,min_samples_leaf=4,min_samples_split=14)
model.fit(X_train,y_train)
